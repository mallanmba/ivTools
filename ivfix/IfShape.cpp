...
void
IfShape::addNodesForLevel(SoGroup *group, int level, SbBool useSoTransform)
{
...
#define ADD_LIST(l)	if (l != NULL) {				      \
    ...
    if (useSoTransform) { 
          // SoTransform is used when -m is specified instead of SoMatrixTransform.
          // It is useful for better file readability.
          // But it can result in worse performance.
          SoTransform *tr = new SoTransform;
          group->addChild(tr);
          tr->setMatrix(transform.getValue());
      } else {
