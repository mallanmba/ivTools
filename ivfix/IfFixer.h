...
class IfFixer {
  ...
  public:
    ...
    // Sets flags indicating whether to output SoMatrixTransform or
    // SoTransform. The default is FALSE that results in using of
    // SoMatrixTransform for transformations (better performance
    // but worse file readability).
    void		setUseSoTransform(SbBool flag)	 { useSoTransform = flag; }
